...
public class MaterialWaveView extends View implements MaterialHeadListener {
    ...
    public int defaulWaveHeight;
    public int defaulHeadHeight;
    private Path path;
    private Paint paint;
    private int color;
    ...
    public void setDefaulWaveHeight(int defaulWaveHeight) {
        this.defaulWaveHeight = defaulWaveHeight;
    }
    ...
    public void setDefaulHeadHeight(int defaulHeadHeight) {
        this.defaulHeadHeight = defaulHeadHeight;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        path.quadTo(getMeasuredWidth() / 2.0f, (float) (headHeight + waveHeight), (float)getMeasuredWidth(), (float)headHeight);
